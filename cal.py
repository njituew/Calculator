...
make_digit_button('6').grid(column=0, row=2, stick='wens', padx=3, pady=3)
make_digit_button('7').grid(column=1, row=2, stick='wens', padx=3, pady=3)
make_digit_button('8').grid(column=2, row=2, stick='wens', padx=3, pady=3)
